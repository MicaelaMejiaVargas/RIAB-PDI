 ...
 * @property {number} telefono - DNI del Rescatista.
 * @property {string} direccion - La direccion del rescatista.
 * @property {string} genero - El nombre del rescatista.
 * @property {string} email - El nombre del rescatista.
 * @property {string} passw - El nombre del rescatista.
 */
